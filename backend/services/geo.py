"""Referencia territorial mínima: código INEI de departamento -> nombre."""
...
def departamento_de(ubigeo) -> str:
    """Nombre del departamento a partir de un ubigeo de 6 dígitos."""
    code = str(ubigeo or "").strip().zfill(6)[:2]
    return DEPARTAMENTOS.get(code, "Perú")
